...
app.use(socketIoWebPlugin,{
        connect(msg){
            ...
            if(M.gp.$route.fullPath=="/simu_skq"){
                M.Component.simu_skq.eventWxClientConnect(msg);
            }
        ...
        disconnect(msg){
            ...
            if(M.gp.$route.fullPath=="/simu_skq"){
                M.Component.simu_skq.socketIoDisConnect();
                return;
            }
        },
        event(msg){
            ...
            switch (msg.method){
                case JsonRpcEventMethodEnum.vtcLog:{
                   if(M.gp.$route.fullPath=="/hard_skq"){
                    ...
                    if(M.gp.$route.fullPath=="/simu_skq"){
                        M.Component.simu_skq.eventVtcLog(msgData);
                        return;
                    }
                    break;
                }
                case JsonRpcEventMethodEnum.wxClientConnect:{
                    ...
                    if(M.gp.$route.fullPath=="/simu_skq"){
                        M.Component.simu_skq.eventWxClientConnect({code:0});
                    }
                    break;
                }
            }
        ...
        changeChannel(v){
            ...
            switch (M.gp.$route.fullPath){
                ...
                case "/simu_skq":{
                    M.Component.simu_skq.dispValue=v.disp;
                    break;
                }
