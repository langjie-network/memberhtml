...
if(M.isPc){
    importStyle("MingMenuItem","/memberhtml/simu/component/MingMenu/MingMenuItemPc.css");
}else {
    importStyle("MingMenuItem","/memberhtml/simu/component/MingMenu/MingMenuItem.css");
}
