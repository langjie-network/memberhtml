...
if(M.isPc){
    importStyle("MingMenuItem","/memberhtml/product/component/MingMenu/MingMenuItemPc.css");
}else {
    importStyle("MingMenuItem","/memberhtml/product/component/MingMenu/MingMenuItem.css");
}
